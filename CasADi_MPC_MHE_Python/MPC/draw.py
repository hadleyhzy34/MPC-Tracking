...
class Draw_MPC_point_stabilization_v1(object):
    def __init__(self, robot_states, init_state, target_state, rob_diam=0.3, export_fig=False):
...
class Draw_MPC_Obstacle(object):
    def __init__(self, robot_states, init_state, target_state, obstacle, rob_diam=0.3, export_fig=False):
        self.robot_states = robot_states
        self.init_state = init_state
        self.target_state = target_state
        self.rob_radius = rob_diam / 2.0
...
class Draw_MPC_tracking(object):
    def __init__(self, robot_states, init_state, rob_diam=0.3, export_fig=False):
        self.init_state = init_state
        self.robot_states = robot_states
