...
if __name__ == '__main__':
    ...
    ### define
    Q = np.array([[5.0, 0.0, 0.0],[0.0, 5.0, 0.0],[0.0, 0.0, 0.0]])
    ...
    while(mpciter-sim_time/T<0.0):
        ...
        # import ipdb;ipdb.set_trace()
        ## set parameter
        c_p = np.concatenate((next_controls.reshape(-1, 1), ref_traj[:N+1,:].reshape(-1, 1)))
        ...
        for i in range(N+1):
            plt.text(ref_traj[i,0], ref_traj[i,1], str(i))
